...
If you follow the [Import Sample](https://hisplayer.github.io/UnityiOS-SDK/#/import-sample) section, please, refer to the GameObject **ScreenRawImage** and check the **Raw Image** component. You
